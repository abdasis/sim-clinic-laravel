...
- FK `medical_record_id` → **`cascadeOnDelete`** aman: parent (`medical_records`) di-soft-delete, cascade DB hanya saat hard-delete parent (kasus terlarang/jarang). Treatment record tidak punya nilai mandiri tanpa rekam medis.
