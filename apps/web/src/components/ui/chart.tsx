...
// Named import, bukan namespace: `import * as` menahan seluruh recharts di
// bundel karena bundler tidak bisa membuktikan anggota mana yang tidak
// dipakai. Yang benar-benar dipakai hanya lima nama di bawah.
