    ...
    <div className="flex min-h-svh flex-col">
      ...
      <main className="flex-1">
        ...
        <PromoSection
          ...
          items={data.promos}
        />
        <ContentBanner tenant={tenant} section={sections.pharma_banner} />
        <BookingCta tenant={tenant} section={sections.booking_cta} />
        <BrandSection
          id="brand"
        ...
        />
        <EstoreCta tenant={tenant} section={sections.estore_cta} />
      </main>
      ...
      <ChatWidget
        enabled={data.settings?.chat_widget_enabled ?? false}
        number={data.settings?.chat_widget_number}
        label={t("company_profile.chat_with_us")}
      />
    </div>
  )
}
