...
return [
    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                ...
                'exclude' => [
                    ...
                    // Tanpa baris ini arsip baru ikut memuat seluruh arsip
                    // lama, dan ukurannya berlipat tiap kali backup jalan.
                    storage_path('app/backups'),
                    // Log tidak perlu dipulihkan; isinya justru bagian yang
                    // paling cepat menggemukkan arsip.
                    storage_path('logs'),
                ],
         ...
         */
        // Dump SQL mentah adalah teks yang sangat mudah dimampatkan, dan
        // memampatkannya sebelum masuk zip menekan puncak pemakaian disk saat
        // backup berjalan — bukan cuma ukuran akhirnya.
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => env('BACKUP_NOTIFICATION_EMAIL', 'admin@simclinic.test'),
    ...
    'cleanup' => [
        ...
        /*
         * ponytail: default retention; tighten when storage grows.
         */
        'default_strategy' => [
            /*
